...
class Bert_BiLSTM_CRF(nn.Module):
    def __init__(self, model, tag_to_ix, hidden_dim=768, train_type='PLM-BiLSTM-CRF'):
    ...
    def _bert_enc(self, x):
        ...
        """
        with torch.no_grad():
            encoded_layer, _ = self.bert(input_ids=x, return_dict=False)
    ...
    def _get_lstm_features(self, sentence):
        ...
        if self.train_type == 'PLM-BiLSTM-CRF':
