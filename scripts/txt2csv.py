...
if __name__ == '__main__':
    json_dict = '../data/label_2_id.json'
    get_dict('../data/train.txt', json_dict)  # 生成label2id字典，存储到json_dict
    change('../data/train.txt', '../data/train.csv', json_dict)
    change('../data/dev.txt', '../data/dev.csv', json_dict)
